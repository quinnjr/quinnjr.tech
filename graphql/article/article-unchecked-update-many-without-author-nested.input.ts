...
export class ArticleUncheckedUpdateManyWithoutAuthorNestedInput {
    ...
    set?: Array<Prisma.AtLeast<ArticleWhereUniqueInput, 'id' | 'title' | 'titleSlug'>>;

    @Field(() => [ArticleWhereUniqueInput], {nullable:true})
    @Type(() => ArticleWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<ArticleWhereUniqueInput, 'id' | 'title' | 'titleSlug'>>;

    @Field(() => [ArticleWhereUniqueInput], {nullable:true})
    @Type(() => ArticleWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<ArticleWhereUniqueInput, 'id' | 'title' | 'titleSlug'>>;

    @Field(() => [ArticleWhereUniqueInput], {nullable:true})
    @Type(() => ArticleWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<ArticleWhereUniqueInput, 'id' | 'title' | 'titleSlug'>>;
